//package de.kuno.lazyjam.gameengine.logics.concrete.collisiondetection;
//
...
//		// getGameObject().getPos().copy().add(vHeight).add(vWidth);
...
//		boolean bottomRight = otherComp.shape.contains(getGameObject().getPos().x + width, getGameObject().getPos().y
//				+ height);
//		if (topLeft && topRight) {
//			return DIRECTION.UP;
//		}
